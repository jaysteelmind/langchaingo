...
func setupTestClient(t *testing.T, model string, responseFormat *ResponseFormat, opts ...Option) *Client {
	t.Helper()
...
func TestClient_CreateChatCompletion(t *testing.T) {
	...
	client := setupTestClient(t, "gpt-4.1-mini", nil)
...
func TestClient_CreateEmbedding(t *testing.T) {
	...
	client := setupTestClient(t, "text-embedding-ada-002", nil)
...
func TestClient_CreateEmbeddingWithDimensions(t *testing.T) {
	...
	client := setupTestClient(t, "text-embedding-3-small", nil, WithEmbeddingDimensions(256))
...
func TestClient_WithResponseFormat(t *testing.T) {
	...
	client := setupTestClient(t, "gpt-4.1-mini", respFormat)
